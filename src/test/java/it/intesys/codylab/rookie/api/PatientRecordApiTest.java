...
public class PatientRecordApiTest {
    ...
    void createPatientRecordTest () throws Exception {
        ...
        String expectedTreatmentMade = "camomilla";
    ...
    void getPatientRecordTest () throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.get(PatientRecordApi.API_PATIENT_RECORD_ID, id)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();
        ...
        Assertions.assertEquals(expectedTreatmentMade, patientRecordDTO.getTreatmentMade(), "treatmentMade");
    }
    ...
    void updatePatientRecordTest () throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.put(PatientRecordApi.API_PATIENT_RECORD_ID, id).contentType(MediaType.APPLICATION_JSON).content(jsonRequest)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();
    ...
    void deletePatientRecordTest () throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.delete(PatientRecordApi.API_PATIENT_RECORD_ID, id)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();

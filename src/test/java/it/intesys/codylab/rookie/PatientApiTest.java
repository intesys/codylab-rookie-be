...
public class PatientApiTest {
    ...
    void updatePatientTest () throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.put("/api/patient", id).contentType(MediaType.APPLICATION_JSON).content(jsonRequest)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();
    ...
    void deletePatientTest () throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.delete("/api/patient/{id}", id)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();

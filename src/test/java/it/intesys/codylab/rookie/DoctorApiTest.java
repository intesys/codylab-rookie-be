...
public class DoctorApiTest {
    ...
    void createDoctorTest () throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.post("/api/doctor").contentType(MediaType.APPLICATION_JSON).content(jsonRequest)).andExpect(MockMvcResultMatchers.status().isOk()).andReturn();
